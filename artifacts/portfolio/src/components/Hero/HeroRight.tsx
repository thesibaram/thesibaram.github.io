    ...
    >
      ...
      >
        <h1
          ...
          style={{ fontSize: "clamp(54px, 7.5vw, 110px)", letterSpacing: "-2px" }}
      ...
      >
        <div className="h-px w-8 flex-shrink-0 bg-[var(--px-border)]" />
        <RoleTyper />
      ...
      <motion.p
        ...
        className="font-sans text-[14px] text-[var(--px-muted)] leading-relaxed mb-8 max-w-lg"
      ...
      >
        <a
          ...
          className="inline-flex items-center px-7 py-3 font-mono text-[12px] uppercase tracking-wider font-bold text-[#0D0D10] bg-[var(--px-accent)] border-2 border-[var(--px-accent)]"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 px-7 py-3 font-mono text-[12px] uppercase tracking-wider font-bold text-[var(--px-text)] border-2 border-[var(--px-border)] bg-transparent"
          style={{ transition: "all 150ms ease" }}
          onMouseEnter={(e) => {
            const el = e.currentTarget as HTMLElement
