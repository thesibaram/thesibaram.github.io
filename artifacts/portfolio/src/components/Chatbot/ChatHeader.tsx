    ...
    >
      <div className="flex items-center gap-2">
        <div style={{ color: "var(--px-accent)" }}>
          <PixelBotIcon size={20} />
        </div>
        <span style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "13px", color: "var(--px-text)", fontWeight: 700 }}>
          ASK AI
        </span>
        <span style={{ color: "var(--px-muted)", fontSize: "10px" }}>·</span>
